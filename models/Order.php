...
class Order extends BaseOrder
{
    ...
    public function getUpdateStatus()
    {
        ...
        if(($this->status_id == 3) && ($this->patient) && ($phone = $this->patient->phone)) {
            $text = "Ваш заказ ортопедической обуви/стелек №{$this->id}, готов к выдаче!\nПолучение заказа БЕЗ ЗАПИСИ по адресу:\nВыборгское шоссе 5/1\nт.8(800)2227002\nПн-Сб., с 10-20 ч.,\nперерыв с 14-15ч.\n‼️ПРОСЬБА ЗАБРАТЬ ЗАКАЗ В ТЕЧЕНИИ 3-5 ДНЕЙ, В СВЯЗИ С ОКОНЧАНИЕМ ФИНАНСИРОВАНИЯ‼️";
            //$text = "Ваш заказ ортопедической обуви / стелек №{$this->id}, готов к выдаче! \nПолучение заказа БЕЗ ЗАПИСИ по адресу: \nВыборгское шоссе 5/1 \nт.8(800)2227002\n Пн-Сб., с 10-20 ч., \nперерыв с 14-15ч.";
            //$text_voice = "Ваш заказ ортопедической обуви готов к выдаче! Ждём Вас по адресу: Выборгское шоссе 5 дробь 1 Телефон для связи 8(800)2227002";
            $text_voice = "Ваш заказ ортопедической обуви готов к выдаче! Ждём Вас по адресу: Выборгское шоссе 5 дробь 1 Телефон для связи 8(800)2227002 С понедельника по субботу с десяти до двадцати часов, перерыв с четырнадцати до пятнадцати часов. ПРОСЬБА ЗАБРАТЬ ЗАКАЗ В ТЕЧЕНИИ 3-5 ДНЕЙ, В СВЯЗИ С ОКОНЧАНИЕМ ФИНАНСИРОВАНИЯ";
            //$phone = '+79887608134';
            $visit->sendSmsText($phone, $text);
            $visit->sendVoiceText($phone, $text_voice);
        }
