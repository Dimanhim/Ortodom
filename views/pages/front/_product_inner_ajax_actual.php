        ...
        <ul class="product__parameter-list">
            ...
            <li class="product__parameter-list-item">
                ...
                <div class="radio-list">
                    <?php foreach($materialList as $materialItem) : ?>
                    <div class="radio-item">
                        <input id="radio-item-<?= $materialItem->id ?>" name="radio-item" type="radio" value="<?= $materialItem->id ?>">
            ...
            <?php if($data->brand->full_color_ids) : ?>
                <li class="product__parameter-list-item">
                    <!--
                    ...
                    <ul class="product__parameter-colors">
                        ...
                        foreach($data->brand->full_color_ids as $colorId) :
                            ...
                            ?>
                            <li class="product__parameter-colors-item js_product-color" :class="$el.dataset.index == currentTab && 'active'" style="background: <?= $color->color ?>" x-on:click="currentTab = $el.dataset.index" data-index="<?= $colorId ?>">
