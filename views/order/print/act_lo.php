...
<div class="block">
    <p>
        1. Стороны подтверждают, что в соответствии с договором № <?= $model->fullId ?> от <?= $model->accepted ?> г. Исполнитель выполнил следующие работы Заказчику, а именно изготовил сложную ортопедическую обувь по индивидуальным параметрам изготовления:
    </p>
    <table class="table">
        <tr>
